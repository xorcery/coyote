  ...
  describe Base do
    context "#path" do
      it "is the full path to the file" do
        asset = Base.new("spec/assets/asset/javascript/script1.js")
    ...
    context "#relative_path" do
      it "is the path to the file relative from the process" do
        asset = Base.new("spec/../spec/assets/asset/javascript/script1.js")
