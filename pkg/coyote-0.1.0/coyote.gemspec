...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["bin/coyote", "lib/coyote.rb", "lib/coyote/builder.rb", "lib/coyote/generator.rb"]
  s.files = ["Manifest", "Rakefile", "bin/coyote", "lib/coyote.rb", "lib/coyote/builder.rb", "lib/coyote/generator.rb", "coyote.gemspec"]
